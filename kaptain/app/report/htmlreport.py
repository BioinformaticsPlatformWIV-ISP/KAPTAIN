...
from kaptain.app.report.htmlbase import HtmlBase
from kaptain.app.report.htmlelement import HtmlElement
from kaptain.resources import LOGO_SCIENSANO, CSS_STYLE
...
class HtmlReport(HtmlBase):
    ...
    def initialize(self, title: str, css_style: Path = CSS_STYLE) -> None:
        """
